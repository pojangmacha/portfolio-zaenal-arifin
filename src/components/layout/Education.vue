<template>
    <section class="p-16">
        ...
        <ul class="mt-10 space-y-8">
            ...
            from-[#1f1elc99]" v-for="(item,index) in Education" :key="index"
            >
            ...
            <section class="w-full lg:w-3/4 lg:pl-4 text-center lg:textleft">
                <header>
...
const Education=ref([
    {
     duration:'2017 - 2021',
     School:'Institut Bisnis dan Informatika IBIK Kosgoro 1957 Jakarta',
     degree:'Bachelor Degree Information Systems'
    },
    {
     duration:'2023',
     School:'Bootcamp Sanbercode',
